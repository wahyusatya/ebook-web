...
const UserDashboard = () => {
  ...
  const fetchBookmarkedEbooks = useCallback(async () => {
    try {
      ...
      // Optionally set an error for bookmarks specifically
    }
  }, []);
  */
  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent">
      ...
      <main className="flex-grow container mx-auto p-4 sm:p-6">
        {user && (
          <h1 className="text-3xl font-bold text-green-light mb-6 text-center">
        ...
        <div className="relative mb-8 max-w-xl mx-auto">
          ...
          <input
            ...
            className="w-full p-3 pl-10 text-gray-100 border border-green-dark rounded-lg bg-gray-800 focus:ring-green-medium focus:border-green-medium"
          />
        </div>
        ...
        {bookmarkedEbooks.length > 0 && (
          <div className="mb-10">
            <h2 className="text-2xl font-semibold text-green-light mb-4 text-center">E-book yang Disimpan</h2>
        ...
        */}
        ...
        {/* All Ebooks Section */}
        <div className="mb-8">
            <h2 className="text-2xl font-semibold text-green-light mb-4 text-center">Semua E-book</h2>
